...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 20 avr. 2022 à 11:23
...
(112, 'HTML <form> Action Attribute', '<form action=\"/action_page.php\" method=\"get\">   <label for=\"fname\">First name:</label>   <input type=\"text\" id=\"fname\" name=\"fname\"><br><br>   <label for=\"lname\">Last name:</label>   <input type=\"text\" id=\"lname\" name=\"lname\"><br><br>   <input type=\"submit\" value=\"Submit\"> </form>'),
(113, 'HTML <form> autocomplete Attribute', '<form action=\"/action_page.php\" method=\"get\" autocomplete=\"on\">   <label for=\"fname\">First name:</label>   <input type=\"text\" id=\"fname\" name=\"fname\"><br><br>   <label for=\"email\">Email:</label>   <input type=\"text\" id=\"email\" name=\"email\"><br><br>   <input type=\"submit\"> </form>'),
...
(120, 'Print text c++', '#include <iostream> using namespace std;  int main() {   cout << \"Hello World!\";   return 0; }  = hello world'),
(121, 'Using many cout object', '#include <iostream> using namespace std;  int main() {   cout << \"Hello World!\";   cout << \"I am learning C++\";   return 0; }   = #include <iostream> using namespace std; ​ int main() {   cout << \"Hello World!\";   cout << \"I am learning C++\";   return 0; } ​ = Hello World!I am learning C++'),
